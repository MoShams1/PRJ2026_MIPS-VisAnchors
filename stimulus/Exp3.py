...
anchor_positions_base = {
    ...
    9: [+2, 0],                                  # NEU: up/down-Kante ∩ Probe-Höhe (rechts)
    10: [-2, 0],                                 # NEU: up/down-Kante ∩ Probe-Höhe (links)
}
...
condition_specs = {
    ...
    3: ('up',    [3, 4, 5]),
    4: ('left',  [4, 1, 6]),
    5: ('lr_axis', [6, 8]),     # NEU: Spitze+Basismitte aus right/left
    6: ('ud_axis', [9, 10]),    # NEU: Dreieckskanten aus up/down auf y=0
}
